...
# Set new Finder windows to go to Home
...
# Group items by kind and sort by name in all Finder windows by default
defaults write com.apple.finder FXPreferredGroupBy -string "Kind"
/usr/libexec/PlistBuddy \
    -c "Set :StandardViewOptions:ColumnViewOptions:ArrangeBy       string  dnam"  \
    ~/Library/Preferences/com.apple.finder.plist

# Remove all .DStore files
...
sudo chmod 700 /System/Library/CoreServices/Search.bundle/Contents/MacOS/Search
